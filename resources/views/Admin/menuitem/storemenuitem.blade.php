...
<link href="{{ asset('css/storemenuitem.css') }}" rel="stylesheet" type="text/css" >
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="card card-nav-tabs">
                    ...
                    <form class="from-vertical" action="{{$Data['globalVariable']['shortUrl']}}/menuitem/store" method="post">
                    <div class="card-body ">
                                ...
                                <div class="col-md-12">
                                    <div class="card">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-6">
                                                <input type="text" name="navOrder" class="from-conrol">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-6">
                                                <label class="switch">
                                                    <input type="checkbox" value=""  id="checboxvisible"  onclick="visiblefunctioninstore()" >
